...
namespace DisabledWhileProcessing_1
{
	using System;
	...
	internal class MyDialog : Dialog
	{
		...
		public void Button_Pressed(object sender, EventArgs e)
		{
			...
			Title = "Processing...";
			Show(false); // Don't require a response for a 'static' update, otherwise the next updates will not work.

			_controller.Engine.Sleep(1000);
